...
- (MyPageControl *)pageControl
{
    ...
    if (self.totalPageCount > 1) {
        if (!_pageControl) {
            ...
            CGRect pageControlFrame = CGRectMake(self.scrollView.frame.size.width - pageControlWidth - 10 , 0.9 * CGRectGetHeight(self.scrollView.frame) + 4.5, pageControlWidth, normalDotImage.size.height);
...
//        NSLog(@"alalala : %@", NSStringFromCGRect(rightRect));
