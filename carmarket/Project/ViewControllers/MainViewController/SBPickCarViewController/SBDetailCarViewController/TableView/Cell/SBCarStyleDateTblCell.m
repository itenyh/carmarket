...
- (void)display:(NSDictionary *)info
{
    ...
    for (int i = 0; i < 4; i++) {
        ...
        [b bk_addEventHandler:^(id sender) {
            ...
            RUPWarning([[ITUtils viewControllerFor:self] performSelector:@selector(SBCarStyleDateTblCell_Button:) withObject:b]);
    ...
    [scrollView setContentSize:CGSizeMake(5 * 80, scrollView.frame.size.height)];
