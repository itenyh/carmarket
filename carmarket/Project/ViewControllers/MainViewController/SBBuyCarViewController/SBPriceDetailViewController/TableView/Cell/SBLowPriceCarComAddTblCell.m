...
@implementation SBLowPriceCarComAddTblCell
...
- (void)display:(NSDictionary *)info
{
    ...
    [ITUIKitHelper pointSet:icon piont:CGPointMake(-1, ([SBLowPriceCarComAddTblCell getHeight:info] - icon.frame.size.height) / 2.0)];
}
